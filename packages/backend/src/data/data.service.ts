...
export class DataService implements OnModuleInit {
    constructor(
        ...
        private readonly qualityFactoreScoreRepository: Repository<QualityFactorScore>,
    ) {}
    ...
    private async isDatabasePopulated(): Promise<boolean> {
        ...
        const countScore = await this.qualityFactoreScoreRepository.count();
    ...
    private async populateDatabase(): Promise<void> {
        ...
        // const craftsmanFileContent = fs.readFileSync(
        //     craftsmanFilePath,
        //     'utf-8',
        // );
        ...
        // const postalCodeFileContent = fs.readFileSync(
        //     postalCodeFilePath,
        //     'utf-8',
        // );
        ...
        // await this.qualityFactoreScoreRepository.save(qualityScoreSeed);
    }
}
